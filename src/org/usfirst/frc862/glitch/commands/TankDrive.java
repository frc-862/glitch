...
public class TankDrive extends Command {
    private JoystickFilter leftFilter = new JoystickFilter(Constants.dead_band, Constants.STICKTION_SPEED, 1, JoystickFilter.Mode.SQUARED);
    private JoystickFilter rightFilter = new JoystickFilter(Constants.dead_band, Constants.STICKTION_SPEED, 1, JoystickFilter.Mode.SQUARED);
