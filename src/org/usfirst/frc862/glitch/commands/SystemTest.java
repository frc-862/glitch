...
public class SystemTest extends StatefulCommand {
    ...
    public void testLeftMotor1() {
        RobotMap.driveTrainLeft1.set(nextWithValue(Constants.MotorTestPower, 0));
    }
    ...
    public void testLeftMotor2() {
        RobotMap.driveTrainLeft2.set(nextWithValue(Constants.MotorTestPower, 0.0));
    }
    ...
    public void testLeftMotor3() {
        RobotMap.driveTrainLeft3.set(nextWithValue(Constants.MotorTestPower, 0.0));
    }
    ...
    public void testRightMotor2() {
        RobotMap.driveTrainRight2.set(nextWithValue(Constants.MotorTestPower, 0.0));
    }
    ...
    public void testRightMotor3() {
        RobotMap.driveTrainRight3.set(nextWithValue(Constants.MotorTestPower, 0.0));
    }
