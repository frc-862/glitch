...
//        CommandGroup cmd = new CommandGroup();
        ...
        if (Robot.startOnLeft()) {
            if (Robot.scaleOnLeft()) {
                cmd.addSequential(new TurnToAbsolutePosition((angle1 < 360) ? angle1 : -155), 2.5);
            } else {
                cmd.addSequential(new TurnToAbsolutePosition((angle1 < 360) ? angle1 : 160), 2.5);
            }
        } else {
            if (Robot.scaleOnLeft()) {
                cmd.addSequential(new TurnToAbsolutePosition((angle1 < 360) ? angle1 : -155, true), 2.5);
            } else {
                cmd.addSequential(new TurnToAbsolutePosition((angle1 < 360) ? angle1 : 160), 2.5);
            }
        }
    ...
    private CommandGroup buildScale() {
        ...
        cmd.addSequential(new EjectCube(is_far ? 0.3 : 0.75), 0.5);
