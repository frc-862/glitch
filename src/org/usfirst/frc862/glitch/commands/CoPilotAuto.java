...
public class CoPilotAuto extends Command {
    ...
    protected void execute() {
        double power = Robot.oi.copilot.getLeftTrigger() - Robot.oi.copilot.getRightTrigger();
