 ...
 *
 */
public class Rotator extends Command {
    private JoystickFilter leftFilter = new JoystickFilter(Constants.dead_band,
            Constants.STICKTION_SPEED_IPS, 1, JoystickFilter.Mode.SQUARED);
    private JoystickFilter rightFilter = new JoystickFilter(Constants.dead_band, Constants.STICKTION_SPEED_IPS, 1, JoystickFilter.Mode.SQUARED);
    ...
    protected void execute() {
        ...
        Robot.driveTrain.setVelocityPercent(leftY, -leftY);
    }
