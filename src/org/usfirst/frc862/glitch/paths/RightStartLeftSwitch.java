...
public class RightStartLeftSwitch implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(28,49,0,0));
        sWaypoints.add(new Waypoint(246,48,50,60));
        sWaypoints.add(new Waypoint(245,283,30,60));
        sWaypoints.add(new Waypoint(176,283,30,60));
        sWaypoints.add(new Waypoint(176,254,0,60));
