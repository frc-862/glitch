...
public class GentleCurve implements PathContainer {
	...
	// WAYPOINT_DATA: [{"position":{"x":50,"y":50},"speed":0,"radius":0,"comment":""},{"position":{"x":100,"y":50},"speed":60,"radius":25,"comment":""},{"position":{"x":125,"y":75},"speed":60,"radius":0,"comment":""}]
	// IS_REVERSED: false
	// FILE_NAME: GentleCurve
}