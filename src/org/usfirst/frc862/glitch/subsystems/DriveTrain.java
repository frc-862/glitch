...
//        setDefaultCommand(new TankDrive());
    ...
    public DriveTrain() {
        ...
        left1.configOpenloopRamp(0.1, Constants.TALON_TIMEOUT);
        right1.configOpenloopRamp(0.1, Constants.TALON_TIMEOUT);
    ...
    public void setVelocityMode(final Mode vmode) {
        ...
        left1.setSelectedSensorPosition(0, Constants.LOWGEAR_IDX, Constants.TALON_TIMEOUT);
        ...
        right1.configAllowableClosedloopError(Constants.LOWGEAR_IDX, Constants.LOWGEAR_ALLOWED_DRIVE_ERROR, Constants.TALON_TIMEOUT);
        right1.setSelectedSensorPosition(0, Constants.LOWGEAR_IDX, Constants.TALON_TIMEOUT);
        ...
        left1.setSelectedSensorPosition(0, Constants.HIGHGEAR_IDX, Constants.TALON_TIMEOUT);
        ...
        right1.setSelectedSensorPosition(0, Constants.HIGHGEAR_IDX, Constants.TALON_TIMEOUT);
        right1.configAllowableClosedloopError(Constants.HIGHGEAR_IDX, Constants.HIGHGEAR_ALLOWED_DRIVE_ERROR, Constants.TALON_TIMEOUT);
...
//        right1.selectProfileSlot(Constants.HIGHGEAR_IDX, 0);
        ...
        left1.config_kP(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_P,Constants.TALON_TIMEOUT);
        left1.config_kI(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_I, Constants.TALON_TIMEOUT);
        left1.config_kD(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_D,Constants.TALON_TIMEOUT);
        left1.config_kF(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_F,Constants.TALON_TIMEOUT);
        left1.configAllowableClosedloopError(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_ALLOWED_DRIVE_ERROR, Constants.TALON_TIMEOUT);
        right1.config_kP(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_P,Constants.TALON_TIMEOUT);
        right1.config_kI(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_I, Constants.TALON_TIMEOUT);
        right1.config_kD(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_D,Constants.TALON_TIMEOUT);
        right1.config_kF(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_DRIVE_F,Constants.TALON_TIMEOUT);
        right1.configAllowableClosedloopError(Constants.LOWGEAR_IDX, Constants.HIGHGEAR_ALLOWED_DRIVE_ERROR, Constants.TALON_TIMEOUT);
    }
