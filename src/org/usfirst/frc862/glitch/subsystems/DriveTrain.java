...
public class DriveTrain extends Subsystem {
    ...
    private final BaseMotorController left2 = RobotMap.leftSlave1;
    private final BaseMotorController left3 = RobotMap.leftSlave2;
    private final BaseMotorController right2 = RobotMap.rightSlave1;
    private final BaseMotorController right3 = RobotMap.rightSlave2;
    ...
    private void eachMotor(Consumer<BaseMotorController> func) {
        func.accept(left1);
        func.accept(left2);
        func.accept(left3);
        func.accept(right1);
    ...
    private void setFollowMode(ControlMode mode) {
        eachMaster((m) -> m.set(mode, 0));
        eachSlave((m,s) -> s.follow(m));
    }

    private void eachMaster(Consumer<TalonSRX> func) {
        func.accept(left1);
        func.accept(right1);
    }
...
//    }
    ...
    private void setVelocityMode(final Mode vmode) {
...
//    }
    ...
    private void slowForSeconds(double seconds) {
