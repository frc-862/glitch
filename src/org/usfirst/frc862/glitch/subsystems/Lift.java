...
public class Lift extends Subsystem {
    ...
    private ScalePos scalePos;
    private State state;
    private Limit elevatorLimit;
    ...
    public Lift() {
        ...
        elevator.configContinuousCurrentLimit(30, Constants.TALON_TIMEOUT);
...
//            Logger.info("Rev Limit" + elevator.getSelectedSensorPosition(0));
        ...
        if (controlElevator) {
            ...
            if (elevatorVelocity > 0 && elevatorLimit == Limit.Top) {
                elevatorVelocity = 0;
            } else if (elevatorVelocity < 0 && elevatorLimit == Limit.Bottom) {
                elevatorVelocity = 0;
            }
            SmartDashboard.putNumber("elevator power", elevatorVelocity);
            elevator.set(ControlMode.Velocity, elevatorVelocity);
        } else {
            SmartDashboard.putNumber("elevator power", -777);
        }
    }
...
//    }
    ...
    public boolean atSwitch() {
        return LightningMath.epsilonEqual(fourbarPosition, Constants.FOURBAR_SWITCH_POS, Constants.FOURBAR_EPSILON) &&
