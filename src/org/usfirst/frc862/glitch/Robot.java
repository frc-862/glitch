...
public class Robot extends TimedRobot {
    ...
    SendableChooser<String> overrideChooser = new SendableChooser<>();
...
//    private Looper reallySlowLooper;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        overrideChooser.addDefault("No override", "no");
        overrideChooser.addObject("Far 1 cube", "f1c");   //one not an L
        overrideChooser.addObject("Near 2 cube", "n2c");
        SmartDashboard.putData("Override Multi", overrideChooser);
...
//            shifter.setDefaultCommand(new HighGearAutoShift());
    ...
    public static String getOverrideValue() {
        return overrideChooser.getSelected();
        return overrideChooser.getSelected();
    }
}
