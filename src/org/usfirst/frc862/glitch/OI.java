...
import org.usfirst.frc862.glitch.paths.CurveLeft;
...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Manual Control Four Bar", new ManualControlFourBar());


        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

        SmartDashboard.putData("Straight", new Straight());
        SmartDashboard.putData("Curve Left", new CurveLeft());
