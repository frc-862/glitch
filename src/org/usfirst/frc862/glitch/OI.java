...
public class OI {
    ...
    public OI() {
        ...
        SendableChooser chooseyMan = new SendableChooser();
        chooseyMan.addDefault("Do this", new UpShift());
        chooseyMan.addObject("Do this also", new DownShift());
        SmartDashboard.putData("Hello", chooseyMan);
